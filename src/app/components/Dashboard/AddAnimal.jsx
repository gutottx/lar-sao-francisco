    ...
    return ( 
        ...
        <div className="text-black">
                ...
                <h1 className="text-[32px] font-bold mb-10">Adicionar Animal</h1>
                    ...
                    <div className="max-w-[750px] min-w-[750px] justify-center">
                            ...
                            <div className="w-full flex flex-col">
                                ...
                                <div className="">
                                    <p>Porte</p>
                                    <select name="" id="" className="rounded-xl p-3  bg-white  w-72">
                    ...
                    <div className="max-w-[750px] min-w-[750px] justify-center mt-10">
                        ...
                        <div className="my-4">
                            ...
                            <div className="my-4">
                                <p>História</p>
                                <textarea name="" id="" cols="25" rows="8" className="bg-white resize-none w-full rounded-bl-xl p-3" placeholder="Conte a história do animal"></textarea>                                
                            </div>
                    </div> 
            ...
            <div className="my-5 mb-10 flex gap-2">
                <div className="relative">
                  ...
                  <div className="absolute p-1 mt-1.5">
                    <button onClick={handleDelete} className="text-red-500 cursor-pointer hover:text-black"><Icon icon="tabler:trash" height={25} alt=""/></button>
                  </div>
                </div>
                <div className="relative">
                  <Image src="/assets/milo2.png" width={155} height={155}></Image>
                  <div className="absolute p-1 mt-1.5">
                    <button onClick={handleDelete} className="text-red-500 cursor-pointer hover:text-black"><Icon icon="tabler:trash" height={25} alt=""/></button>
                            ...
                            <label className="text-[#2B9EED] w-fit rounded-2xl bg-transparent border flex gap-2 items-center px-4 p-2 cursor-pointer"><Icon icon="material-symbols:upload-sharp" height={20} />
                                Adicionar Imagem
        ...
        <div className="max-w-[750px] min-w-[750px] justify-center mt-10">
                        ...
                        <p>URL da imagem do item:</p>
                            ...
                            <div className="w-72">
                                  ...
                                  <input className="rounded-xl bg-white p-3 w-72" type="text" placeholder="Coleira" />
                            </div>
                                <div className="">
                                    <p>Valor do item:</p>
                                    <input className="rounded-xl bg-white p-3 w-72" type="text" placeholder="10" />
                                </div>
                            </div>
