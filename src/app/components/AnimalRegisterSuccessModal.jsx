...
import ico02 from '/public/assets/ico02.png';
    function AnimalRegisterSuccessModal() {
        return (
            <div>
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        <div className="lg:p-10 p-4 flex w-full flex-col justify-center items-center">
                            <div className="flex flex-col justify-center items-center my-5 gap-10">
                                <Image src={ico02} width={50} height={50}></Image>
                                <h1 className="text-[32px] font-bold text-center">Adicionado com sucesso</h1>
                            </div>
...
export default AnimalRegisterSuccessModal;
