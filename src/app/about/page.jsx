...
import ico3mb from "/public/assets/about-dog-sm.png";
import ico3md from "/public/assets/about-dog-md.png";
    ...
    return ( 
        <>
          ...
          <h2 className="font-bold text-3xl my-3 lg:hidden md:hidden md:w-fit">Sobre Nós </h2>
              <Image src={ico3}  className="hidden md:hidden lg:block " alt="Imagem de um cachorro." />
              <Image src={ico3mb}  className="block md:hidden lg:hidden w-full" alt="Imagem de um cachorro." />
              <Image src={ico3md}  className="md:flex lg:hidden hidden w-full" alt="Imagem de um cachorro." />
